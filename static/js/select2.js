...
define('select2/i18n/en',[],function () {
  ...
  return {
    ...
    inputTooShort: function (args) {
      ...
      var message = 'Please enter ' + remainingChars + ' or more characters. (Only addresses starting with a 1 are currently supported.)';
    ...
    noResults: function () {
      return 'No results found. (Only addresses starting with a 1 are currently supported.)';
    },
    searching: function () {
      return 'Searching…';
    }
